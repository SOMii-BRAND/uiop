...
def Zeek():
    os.system('clear')
    print logo2
    print"\033[1;94mSELECT ONE'
    print"\033[1;94m[1]\x1b[1;91mBangladesh"
    time.sleep(0.05)
    print"\033[1;94m[2]\x1b[1;92mUSA"
    time.sleep(0.05)
    print"\033[1;94m[3]\x1b[1;93mU.k"
    time.sleep(0.05)
    print"\033[1;94m[4]\x1b[1;94mIndia"
    time.sleep(0.05)
    print"\033[1;94m[5]\x1b[1;95mBrazil"
    time.sleep(0.05)
    print"\033[1;94m[6]\x1b[1;96mJapan"
    time.sleep(0.05)
    print"\033[1;94m[7]\x1b[1;91mkorea"
    time.sleep(0.05)
    print"\033[1;94m[8]\x1b[1;93mitly"
    time.sleep(0.05)
    print"\033[1;94m[9]\x1b[1;93mspain"
    time.sleep(0.05)
    print"\033[1;94m[10]\x1b[1;94mpoland"
    time.sleep(0.05)
    print '\033[1;94m[11]\x1b[1;95mPakistan'
    time.sleep(0.05)
    print"\033[1;94m[12]\x1b[1;96mindonesia"
    time.sleep(0.05)
    print"\033[1;94m[13]\x1b[1;91mGreece"
    time.sleep(0.05)
    print"\033[1;94m[14]\x1b[1;92mAustrlia"
    time.sleep(0.05)
    print"\033[1;94m[15]\x1b[1;93mCanada"
    time.sleep(0.05)
    print"\033[1;94m[16]\x1b[1;94mCHINA"
    time.sleep(0.05)
    print"\033[1;94m[17]\x1b[1;95mdenmark"
    time.sleep(0.05)
    print"\033[1;94m[18]\x1b[1;96mFrance"
    time.sleep(0.05)
    print"\033[1;94m[19]\x1b[1;91mGermany"
    time.sleep(0.05)
    print"\033[1;94m[20]\x1b[1;92mSarilanka"
    time.sleep(0.05)
    print"\033[1;94m[21]\x1b[1;93mTurkey"
    time.sleep(0.05)
    print"\033[1;94m[22]\x1b[1;94mU.A.E"
    time.sleep(0.05)
    print"\033[1;94m[23]\x1b[1;95mSudia arabia"
    time.sleep(0.05)
    print"\033[1;94m[24]\x1b[1;96misreal"
    time.sleep(0.05)
    print"\033[1;94m[25]\x1b[1;91miran"
    time.sleep(0.05)
    print 45*'-'
    action()
